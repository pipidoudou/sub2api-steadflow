...
const (
	...
	SettingKeyThesisVerticalEnabled            = "thesis_vertical_enabled"
	SettingKeyThesisVerticalBrandDomain        = "thesis_vertical_brand_domain"
	SettingKeyThesisVerticalPrimaryPlanIDs     = "thesis_vertical_primary_plan_ids"
	SettingKeyThesisVerticalCodexGuideURL      = "thesis_vertical_codex_guide_url"
	SettingKeyThesisVerticalSkillPackURL       = "thesis_vertical_skill_pack_url"
	SettingKeyThesisVerticalSupportDisciplines = "thesis_vertical_support_disciplines"
	SettingKeyCodexClientSkillsCatalogJSON     = "codex_client_skills_catalog_json"
