import upstream from './en/index'
import { mergeLocaleTrees } from './merge'
...
const legacy = {
  ...
  thesis: {
    common: {
      ...
      navCases: 'Cases',
      openLanding: 'Open overview',
      openExamples: 'Open examples',
      proposalWorkflow: 'Proposal workflow',
      stackTitle: 'Recommended stack',
      stackChatgpt: 'ChatGPT: clarify the topic, draft the first outline, and build the question list.',
      stackCodex: 'Codex: execute searches, organize sources, batch-rewrite sections, and run comparisons.',
      stackSkillPack: 'Thesis skill pack: lock in proposal templates, literature cards, and advisor Q&A scripts.',
      launchDisciplines: 'Launch disciplines',
      disciplineTcm: 'Traditional Chinese Medicine',
      disciplineComputerScience: 'Computer Science',
      disciplineEducation: 'Education',
      backToExamples: 'Back to proposal examples',
      nextStep: 'Next step',
      prepChecklist: 'Prep checklist'
    },
    landing: {
      title: 'Thesis Proposal Workspace',
      heroTitle: 'Simple chat will never write a strong thesis proposal',
      heroDescription: 'Many users can get a few plausible paragraphs from chat, but they still cannot produce a proposal worth discussing with an advisor. The real issue is not “writing.” It is narrowing the topic, finding enough literature, building a stable structure, and defending the method.',
      primaryCta: 'Quick start in 5 minutes',
      subscriptionCta: 'View the ChatGPT proposal package',
      secondaryCta: 'Browse proposal examples',
      problemTitle: 'Why simple chat prompts fail',
      problemHeadline: 'The common problem is not that AI cannot write. The prompt skips the hardest parts.',
      badPanelTitle: 'Common mistakes',
      goodPanelTitle: 'Better workflow',
      problemSummary: 'All of these prompts sound like “help me write a thesis proposal,” but they skip the hard parts: whether the topic is workable, whether the literature is strong enough, whether the method stands up, and what the advisor will challenge.',
      badExamples: {
        item1: '“Write me a proposal on TCM treatment for insomnia.”',
        item2: '“Give me a full computer science proposal topic and draft right away.”',
        item3: '“Generate the background, significance, method, and references for an education thesis.”'
      },
      rightWay: {
        item1Title: 'Search literature before locking the topic',
        item1Body: 'Check what kinds of studies exist, whether recent discussion is continuous, and whether Chinese and English sources are enough before deciding the topic is worth writing.',
        item2Title: 'Narrow the research object before building the outline',
        item2Body: 'Define object, variable, scenario, time frame, and boundaries first. Then organize background, significance, prior work, questions, and method.',
        item3Title: 'Build the evidence chain before asking AI to draft',
        item3Body: 'List the core papers, usable claims, and likely advisor pushback first. The first draft becomes much more stable than a direct “write it for me” request.'
      },
      capabilityTitle: 'A good proposal needs combined capabilities, not a single conversation.',
      capabilityIntro: 'What makes a proposal usable is not just “writing.” You need literature search, topic narrowing, research structuring, and repeated defense-style questioning connected together. That combination is the skill set.',
      capabilities: {
        item1Title: 'Search literature',
        item1Body: 'You need to know where to search, what to collect, and how to screen before the proposal can stand on evidence.',
        item2Title: 'Narrow the topic',
        item2Body: 'A broad idea must be reduced into object, variable, scenario, and boundary, otherwise the proposal stays vague.',
        item3Title: 'Build the structure',
        item3Body: 'Background, significance, prior work, questions, method, and chapter logic must form a frame an advisor can review.',
      },
      skillTitle: 'This is not a single prompt',
      skillHeadline: 'It works more like a proposal-stage skill stack.',
      skillIntro: 'ChatGPT helps with questioning, narrowing, and first-pass drafting. Codex executes, organizes, and cross-checks. The thesis skill pack locks the workflow and output format. Together they behave more like a tool than a generic chat.',
      skillModules: {
        item1: 'Turn a broad direction into workable topics before drafting.',
        item2: 'Layer the papers and decide which ones actually belong in the proposal pool.',
        item3: 'Translate the topic and literature into questions, significance, and method structure.',
        item4: 'Map evidence to claims before drafting and mark unsupported gaps explicitly.'
      },
      examplesTitle: 'The first release goes deep on three discipline cases',
      examplesIntro: 'Instead of pretending to cover every major, the first release focuses on Chinese medicine, computer science, and education, where the initial user pipeline already exists.',
    },
    quickStart: {
      title: 'Thesis Quick Start',
      intro: 'For students at the start of the proposal stage: collect the topic, source material, and advisor expectations into one executable workspace.',
      steps: {
        step1Title: '1. Gather the inputs',
        step1Body: 'Prepare the topic keywords, school formatting rules, recent advisor feedback, and the core papers you already have.',
        step2Title: '2. Let ChatGPT draft the clarification checklist',
        step2Body: 'The goal is not to write the proposal immediately. The goal is to force out the object, scope, variables, and case boundaries.',
        step3Title: '3. Hand the checklist to Codex',
        step3Body: 'Have Codex organize search expressions, literature tables, candidate research questions, and method options by discipline.',
        step4Title: '4. Use the thesis skill pack to lock outputs in',
        step4Body: 'Turn the work into a proposal outline, literature cards, and a short advisor briefing for the next iteration.'
      },
      subscriptionTitle: 'Get the subscription and key first',
      subscriptionBody: 'The first launch packages the offer around ChatGPT subscriptions, recharge, and usable key delivery. After that, users move into Codex and the proposal workflow.',
      subscriptionCta: 'Open ChatGPT packages',
      codexGuideCta: 'Open Codex setup guide',
      skillPackTitle: 'Proposal-stage skill pack',
      skillPackBody: 'The first-stage skills stay inside the proposal workflow. They do not pretend to finish the whole thesis. They enforce structure and expose evidence gaps.',
      skillPackCta: 'Download skill pack',
      skills: {
        topicDiscovery: 'Compress a broad area into 3-5 workable topics and explain literature load and method risk.',
        paperTriage: 'Sort papers into background, theory, method, case, and evidence layers so the proposal pool stays usable.',
        proposalStructure: 'Translate the topic, papers, and supervisor constraints into a proposal structure with questions, significance, and method path.',
        evidenceFirstDraft: 'Map claims to evidence before drafting and mark what is grounded versus inferred by the model.'
      },
      checklistTitle: 'Minimum prep before the first run',
      checklist: {
        item1: 'A thesis topic or draft topic',
        item2: 'Your department proposal template or word-count rules',
        item3: 'Three to ten highly relevant papers',
        item4: 'The research direction or constraint your advisor cares about most'
      }
    },
    tutorial: {
      title: 'Thesis Tutorial',
      intro: 'Break the proposal into repeatable collaboration loops instead of hoping one prompt solves everything.',
      phases: {
        phase1Title: 'Phase 1: Topic and research question',
        phase1Body: 'ChatGPT handles divergence and clarification, producing candidate questions, variable definitions, and topic-narrowing suggestions.',
        phase2Title: 'Phase 2: Literature and gap finding',
        phase2Body: 'Codex structures keywords, databases, screening rules, and literature cards so the real gap becomes visible.',
        phase3Title: 'Phase 3: Method and feasibility',
        phase3Body: 'The thesis skill pack templates common method paths so you can compare samples, experiments, interviews, or case-based designs.',
        phase4Title: 'Phase 4: Advisor-facing materials',
        phase4Body: 'Keep the proposal draft, slide outline, likely questions, and defense script in the same deliverable set.'
      },
      deliverablesTitle: 'Artifacts worth keeping every iteration',
      deliverables: {
        item1: 'Versioned research questions',
        item2: 'Literature screening sheet with rejection reasons',
        item3: 'Method comparison table',
        item4: 'Advisor meeting notes'
      }
    },
    literatureGuide: {
      title: 'Literature Guide',
      intro: 'At the proposal stage, the review should prove you understand the state of the field, the active debates, and the gap you can actually enter. It is not a wall of summaries.',
      sections: {
        section1Title: 'Start with the search frame',
        section1Body: 'Combine core concepts, synonyms, method terms, and setting terms. Track how Chinese and English databases behave separately.',
        section2Title: 'Then define screening rules',
        section2Body: 'Be explicit about years, samples, methods, regions, and exclusion reasons so the literature pool does not become noise.',
        section3Title: 'Finally draft the review structure',
        section3Body: 'Organize by themes, method paths, or disagreements in findings, not by a flat list of author summaries.'
      },
      pitfallsTitle: 'Common mistakes',
      pitfalls: {
        item1: 'Searching keywords without recording the search strings, which makes the process impossible to reproduce',
        item2: 'Citing a lot of papers without explaining the actual research gap',
        item3: 'Repeating the same content in the review and the proposal background'
      }
    },
    examples: {
      title: 'Proposal Examples',
      intro: 'These examples stay honest about the proposal stage. They do not pretend the thesis is finished. They show how to organize the topic, literature, method, and defense prep.',
      cards: {
        tcmTitle: 'TCM proposal example',
        tcmBody: 'Centered on classical theory, clinical observation, or case material, with emphasis on concept definition, evidence sources, and research boundaries.',
        csTitle: 'Computer Science proposal example',
        csBody: 'Centered on systems, algorithms, or application settings, with emphasis on problem definition, baselines, metrics, and experimental resources.',
        educationTitle: 'Education proposal example',
        educationBody: 'Centered on classrooms, teacher development, or learning outcomes, with emphasis on subjects, instrument design, and ethical feasibility.'
      }
    },
    exampleDetail: {
      title: 'Proposal Example Detail',
      fallbackName: 'General discipline',
      fallbackSummary: 'This discipline example is still being assembled. You can still use the same proposal workflow to advance the topic, literature, and method design.',
      sectionsTitle: 'Priority outputs for this discipline right now',
      sections: {
        question: 'Research question',
        literature: 'Literature strategy',
        method: 'Method path',
        defense: 'Advisor defense prep'
      },
      tcm: {
        name: 'Traditional Chinese Medicine',
        summary: 'Define the syndrome, classical source, and case scope first, then decide whether the line of work is literature evidence, clinical observation, or comparative experience synthesis.',
        question: 'Specify the disease, syndrome pattern, treatment approach, and observation indicators instead of stopping at “explore its value.”',
        literature: 'Cover TCM databases, core journals, and recent evidence-based studies, while separating classical discourse from modern validation.',
        method: 'State case sources, inclusion and exclusion rules, observation cycles, and how TCM concepts become operationalized variables.',
        defense: 'Prepare for “why this is not just experience summary” and “how you ensure credible evidence” before the advisor asks.'
      },
      computerScience: {
        name: 'Computer Science',
        summary: 'Lock down the problem definition and evaluation first, then decide whether the proposal is a system build, an algorithm improvement, or a scenario validation.',
        question: 'Make the inputs, outputs, constraints, and baselines explicit instead of proposing a vague “optimization based on a model.”',
        literature: 'Group papers by task, method family, and evaluation metric, and record the baselines that compete most directly with your plan.',
        method: 'Specify data sources, runtime environment, core metrics, ablation design, and the cost of reproducibility.',
        defense: 'Expect questions about whether the novelty is real, whether the experiment scale is enough, and whether the workload stays controllable.'
      },
      education: {
        name: 'Education',
        summary: 'Narrow the learners and teaching context first, then choose between survey, interview, action research, or quasi-experimental design.',
        question: 'Turn the school stage, subject, sample group, and teaching issue into questions that can be observed and measured.',
        literature: 'The review should cover theory, local and international practice paths, and the origin of the measurement instruments.',
        method: 'Explain sample access, instrument design, ethics approval, and the analysis method so the proposal does not remain conceptual.',
        defense: 'Prepare scripts for “is the sample large enough,” “is the instrument trustworthy,” and “how far can the conclusions generalize.”'
      }
    }
  },
  ...
  nav: {
    ...
    clientReleases: 'Client Releases',
    settings: 'Settings',
    ...
    thesisVertical: 'Thesis Vertical',
  },
  ...
  admin: {
    thesis: {
      title: 'Thesis Vertical',
      description: 'Manage the china-model.com proposal entry, recommended packages, skill pack, and tutorial links in one place.',
      enableTitle: 'Enable thesis vertical',
      enableHint: 'When enabled, the /thesis routes are public. When disabled, they fall back to /home.',
      baseConfigTitle: 'Base configuration',
      brandDomainLabel: 'Brand domain',
      planIdsLabel: 'Recommended plan IDs',
      codexGuideLabel: 'Codex guide URL',
      skillPackLabel: 'Skill pack URL',
      disciplinesLabel: 'Launch disciplines',
      currentOutputTitle: 'Current output summary',
      currentDomain: 'Current domain',
      currentPlans: 'Current packages',
      currentDisciplines: 'Current disciplines',
      routeMapTitle: 'Default routes',
      launchChecklistTitle: 'Launch checklist',
      launchChecklistDomain: 'Domain and homepage copy confirmed',
      launchChecklistPlan: 'ChatGPT plan IDs bound',
      launchChecklistSkill: 'Codex guide and skill pack links are reachable',
    },
    // Dashboard
    dashboard: {
  ...
  payment: {
    ...
    admin: {
      ...
      pendingFulfillment: 'Awaiting Fulfillment',
      markManuallyFulfilled: 'Mark as Manually Fulfilled (No Email)',
      markManuallyFulfilledConfirm: 'Confirm that the order has already been delivered through another channel. This action only marks the order as completed; it does not assign a subscription, issue rebates, or send notification emails.',
      markManuallyFulfilledSuccess: 'Marked as manually fulfilled. No notification email was sent.',
...
export default mergeLocaleTrees(legacy, upstream)
