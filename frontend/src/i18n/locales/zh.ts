...
const legacy = {
  ...
  thesis: {
    common: {
      brand: 'china-model.com 论文',
      overview: '总览',
      quickStart: '快速开始',
      tutorial: '完整教程',
      literatureGuide: '文献综述',
      examples: '开题范例',
      navProblems: '常见问题',
      navFramework: '核心框架',
      navCases: '学科案例',
      openLanding: '查看总览',
      openExamples: '查看范例',
      proposalWorkflow: '开题阶段工作流',
      stackTitle: '推荐工具栈',
      stackChatgpt: 'ChatGPT：澄清题目、生成第一版提纲与提问清单',
      stackCodex: 'Codex：执行检索、整理材料、批量改写与对照检查',
      stackSkillPack: '论文技能包：固化开题模板、文献卡片与导师问答脚本',
      launchDisciplines: '首发学科',
      disciplineTcm: '中医',
      disciplineComputerScience: '计算机',
      disciplineEducation: '教育',
      backToExamples: '返回开题范例',
      nextStep: '下一步',
      prepChecklist: '准备清单'
    },
    landing: {
      title: '论文开题工作台',
      heroTitle: '简单的对话，永远写不出好论文',
      heroDescription: '很多用户能从聊天里拿到几段像样的话，但拿不到一个能交给导师讨论的开题版本。问题不在“会不会写”，而在题目有没有收窄、文献够不够、结构稳不稳、方法站不站得住。',
      primaryCta: '5 分钟快速开始',
      subscriptionCta: '查看 ChatGPT 开题套餐',
      secondaryCta: '浏览开题范例',
      problemTitle: '为什么简单对话总是得不到好回复',
      problemHeadline: '常见的问题，不是 AI 不会写，而是提问方式跳过了真正困难的部分。',
      badPanelTitle: '常见错误',
      goodPanelTitle: '正确做法',
      problemSummary: '这些提问看起来都像是在“让 AI 帮忙写论文”，但它们都跳过了真正困难的部分：题目可不可写、文献够不够、方法站不站得住、导师会怎么追问。',
      badExamples: {
        item1: '“帮我写一个关于中医治疗失眠的开题报告。”',
        item2: '“我想写一个计算机毕业论文题目，你直接给我完整开题。”',
        item3: '“帮我生成教育学论文的研究背景、意义、方法和参考文献。”'
      },
      rightWay: {
        item1Title: '先找文献，再判断题目',
        item1Body: '先确定能搜到什么类型的研究、近几年有没有连续讨论、中文和英文材料是否够支撑，再决定题目值不值得写。',
        item2Title: '先收窄研究对象，再搭开题结构',
        item2Body: '把对象、变量、场景、时间和边界说清楚，再组织研究背景、意义、现状、问题和方法，不然整篇都会发散。',
        item3Title: '先做证据链，再让 AI 起草',
        item3Body: '把核心文献、可用论点、导师可能追问先列出来，再让模型生成第一版，质量会比直接一句“帮我写”稳定得多。'
      },
      capabilityTitle: '写好论文开题，需要的是组合能力，不是一次性对话。',
      capabilityIntro: '真正能把 proposal 做好的，不只是“会写”，而是至少要把查文献、收窄题目、搭研究结构、反复追问答辩这几类能力串起来。它们组合起来，才是一套 skill。',
      capabilities: {
        item1Title: '查文献',
        item1Body: '先知道去哪找、找什么、怎么筛，才能判断题目有没有依据，不会把开题写成空话。',
        item2Title: '收窄题目',
        item2Body: '把宽泛方向压缩成研究对象、变量、场景和边界，避免题目大而空。',
        item3Title: '搭研究结构',
        item3Body: '把研究背景、意义、现状、问题、方法和章节结构搭成一个导师能看懂的框架。',
      },
      skillTitle: '这不是一个 prompt',
      skillHeadline: '它更像一套 proposal 阶段的 skill 组合。',
      skillIntro: 'ChatGPT 用来帮你提问、收束和起草，Codex 用来执行、整理和对照检查，论文 skill 包用来固定流程和输出格式。三者组合，才会比泛聊天更像一个专业工具。',
      skillModules: {
        item1: '先把方向压缩成可写题目，而不是直接要全文。',
        item2: '把搜到的文献分层，判断哪些真能进开题文献池。',
        item3: '把题目和文献翻译成研究问题、意义和方法结构。',
        item4: '先列证据和论点，再生成草稿，并明确哪里还缺依据。'
      },
      examplesTitle: '首批先把三个学科案例讲透',
      examplesIntro: '当前不是泛学科铺开，而是先围绕你能拿到首批用户的中医、计算机、教育，把开题链路做成更可感知的案例。',
    },
    quickStart: {
      title: '论文快速开始',
      intro: '适合 proposal 刚启动的学生：先把题目、材料和导师预期整理成一个可执行的工作台。',
      steps: {
        step1Title: '1. 收集输入',
        step1Body: '准备题目关键词、学校格式要求、导师最近反馈，以及你已有的核心文献。',
        step2Title: '2. 让 ChatGPT 先出题目澄清清单',
        step2Body: '目标不是直接写开题，而是逼出研究对象、范围、变量、案例边界。',
        step3Title: '3. 把清单交给 Codex 执行',
        step3Body: '让 Codex 按学科模板整理检索式、文献表、潜在研究问题和方法备选。',
        step4Title: '4. 用论文技能包固化产物',
        step4Body: '沉淀成开题提纲、文献卡片和导师会前摘要，方便下一轮迭代。'
      },
      subscriptionTitle: '先拿到可用订阅与 key',
      subscriptionBody: '首期先围绕 ChatGPT 订阅场景组织套餐、充值和 key 发放。买完后直接按教程接入 Codex，再进入论文开题流程。',
      subscriptionCta: '进入 ChatGPT 套餐',
      codexGuideCta: '查看 Codex 配置教程',
      skillPackTitle: '开题阶段 skill 包',
      skillPackBody: '第一阶段 skill 只覆盖 proposal 场景，不碰全文代写。它的作用是约束流程、固定结构、暴露证据缺口。',
      skillPackCta: '下载 skill 包',
      skills: {
        topicDiscovery: '把宽泛方向压缩成 3 到 5 个可写题目，并指出每个题目的文献压力和方法风险。',
        paperTriage: '把你搜到的论文按背景、理论、方法、案例、证据分层，判断哪些值得进开题文献池。',
        proposalStructure: '把题目、文献和导师限制翻译成开题结构，明确研究问题、意义和方法路线。',
        evidenceFirstDraft: '先列论点和证据，再生成草稿；把“已有依据”和“模型推断”分开标注。'
      },
      checklistTitle: '第一次开跑前，至少准备这些',
      checklist: {
        item1: '论文题目或题目草案',
        item2: '学院开题模板或字数要求',
        item3: '3 到 10 篇最相关文献',
    ...
    tutorial: {
      title: '论文完整教程',
      intro: '把开题拆成可重复的协作流程，避免一次 prompt 试图解决所有问题。',
      phases: {
        phase1Title: '阶段一：题目与研究问题',
        phase1Body: 'ChatGPT 负责发散与澄清，产出候选研究问题、变量解释和题目缩圈建议。',
        phase2Title: '阶段二：文献与空白点',
        phase2Body: 'Codex 负责把关键词、数据库、筛选标准和文献卡片结构化，找出真正的研究空白。',
        phase3Title: '阶段三：方法与可行性',
        phase3Body: '论文技能包把常见方法模板化，帮助你比较样本、实验、访谈或案例路径的适配性。',
        phase4Title: '阶段四：答辩材料',
        phase4Body: '把开题报告、PPT 大纲、预期追问和答辩脚本整理成同一套交付物。'
      },
      deliverablesTitle: '建议每轮迭代都保留的交付物',
      deliverables: {
        item1: '研究问题版本记录',
        item2: '文献筛选表与淘汰理由',
        item3: '方法比较表',
    ...
    literatureGuide: {
      title: '文献综述指南',
      intro: 'proposal 阶段的综述目标是证明你知道研究现状、争议点与可切入的空白，而不是堆满摘要。',
      sections: {
        section1Title: '先搭检索框架',
        section1Body: '按核心概念、同义词、方法词和场景词组合检索式，分别记录中文库与英文库表现。',
        section2Title: '再做筛选标准',
        section2Body: '明确年份、样本、方法、地区和排除理由，避免文献池越滚越乱。',
        section3Title: '最后形成综述骨架',
        section3Body: '按研究主题、方法路径或结论分歧组织，而不是按“某某认为”平铺。'
      },
      pitfallsTitle: '常见问题',
      pitfalls: {
        item1: '只搜关键词，不记检索式，导致无法复现',
        item2: '引用很多，但没有解释研究空白',
        item3: '把综述和开题背景写成重复内容'
      }
    },
    examples: {
      title: '开题范例',
      intro: '以下范例都聚焦 proposal 阶段，不是假装完稿，而是展示如何把题目、文献、方法和答辩准备组织起来。',
      cards: {
        tcmTitle: '中医开题范例',
        tcmBody: '围绕经典理论、临床观察或病例数据，强调概念界定、证据来源与研究边界。',
        csTitle: '计算机开题范例',
        csBody: '围绕系统、算法或应用场景，强调问题定义、基线、评估指标与实验资源。',
        educationTitle: '教育开题范例',
        educationBody: '围绕课堂、教师发展或学习成效，强调研究对象、工具设计与伦理可行性。'
      }
    },
    exampleDetail: {
      title: '开题范例详情',
      fallbackName: '通用学科',
      fallbackSummary: '这个学科样例还在整理中。你仍然可以按同样的 proposal 工作流推进题目、文献与方法设计。',
      sectionsTitle: '该学科当前建议优先产出的内容',
      sections: {
        question: '研究问题',
        literature: '文献策略',
        method: '方法路线',
      ...
      tcm: {
        name: '中医',
        summary: '先定义证候、经典来源与病例范围，再决定是走文献证据链、临床观察还是经验总结比较。',
        question: '明确病种、证型、疗法与观察指标，避免题目只停留在“探讨价值”。',
        literature: '同时覆盖中医药数据库、核心期刊与近年循证研究，区分经典论述与现代验证。',
        method: '优先说明病例来源、纳排标准、观察周期与中医概念如何操作化。',
        defense: '提前准备“为什么不是纯经验总结”“如何保证证据可信度”两类追问。'
      },
      computerScience: {
        name: '计算机',
        summary: '先把问题定义和评价方式锁定，再决定是做系统实现、算法改进还是场景验证。',
        question: '把输入、输出、约束条件和 baseline 写清楚，避免题目只是“基于某模型的优化研究”。',
        literature: '按任务、方法族和评测指标归类文献，特别记录与你方案直接竞争的 baseline。',
        method: '明确数据来源、实验环境、核心指标、消融设计与复现实验成本。',
        defense: '导师最常追问的是创新点是否成立、实验规模是否足够、工作量是否可控。'
      },
      education: {
        name: '教育',
        summary: '先收束研究对象和教学场景，再决定走问卷、访谈、行动研究还是准实验路线。',
        question: '把学段、学科、样本群体和想解释的教学问题写成可观察、可测量的问题。',
        literature: '文献综述要同时交代理论基础、国内外实践路径和测量工具来源。',
        method: '说明样本获取、工具设计、伦理审批和数据分析方法，避免方案停留在概念层面。',
        defense: '提前准备“样本是否足够”“工具是否可信”“研究结论能否推广”的答辩脚本。'
      }
    }
  },
  ...
  nav: {
    ...
    ops: '运维监控',
    promoCodes: '优惠码',
    professionalSkills: '专业Skills',
    scriptMarket: '脚本市场',
    clientReleases: '客户端发布',
    settings: '系统设置',
    myAccount: '我的账户',
    lightMode: '浅色模式',
    darkMode: '深色模式',
  ...
  admin: {
    thesis: {
      title: '论文专区配置',
      description: '单独维护 china-model.com 的论文开题入口、推荐套餐、技能包与教程链接。',
      enableTitle: '启用论文专区',
      enableHint: '启用后，/thesis 路由和对应页面对外可见；关闭时自动回退到 /home。',
      baseConfigTitle: '基础配置',
      brandDomainLabel: '展示域名',
      planIdsLabel: '推荐套餐 ID',
      codexGuideLabel: 'Codex 教程链接',
      skillPackLabel: 'skill 包链接',
      disciplinesLabel: '首发学科',
      currentOutputTitle: '当前输出概览',
      currentDomain: '当前域名',
      currentPlans: '当前套餐',
      currentDisciplines: '当前学科',
      routeMapTitle: '默认路由',
      launchChecklistTitle: '上线检查',
      launchChecklistDomain: '域名与首页文案已确认',
      launchChecklistPlan: 'ChatGPT 套餐 ID 已绑定',
      launchChecklistSkill: 'Codex 教程与 skill 包链接可访问',
    },
    // Dashboard
    dashboard: {
      title: '管理控制台',
  ...
  payment: {
    ...
    admin: {
      ...
      retrySuccess: '重试成功',
      paymentTimeout: '支付超时',
      pendingFulfillment: '待发货',
      markManuallyFulfilled: '标记为已手动发货（不发送邮件）',
      markManuallyFulfilledConfirm: '请确认已经通过其他方式完成实际交付。此操作只会把订单标记为已完成，不会分配订阅、发放返利或发送通知邮件。',
      markManuallyFulfilledSuccess: '已标记为手动发货，未发送通知邮件',
      approveRefund: '批准退款',
      retryRefund: '重试退款',
