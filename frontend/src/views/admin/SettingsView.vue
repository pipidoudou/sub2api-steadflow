...
const form = reactive<SettingsForm>({
  ...
  thesis_vertical_enabled: false,
  thesis_vertical_brand_domain: "",
  thesis_vertical_primary_plan_ids: [] as number[],
  thesis_vertical_codex_guide_url: "",
  thesis_vertical_skill_pack_url: "",
  thesis_vertical_support_disciplines: [] as string[],
  codex_client_skills_catalog_json: "[]",
...
async function saveSettings() {
  ...
  try {
    ...
    const payload: UpdateSettingsRequest = {
      ...
      thesis_vertical_enabled: form.thesis_vertical_enabled,
      thesis_vertical_brand_domain: form.thesis_vertical_brand_domain,
      thesis_vertical_primary_plan_ids: form.thesis_vertical_primary_plan_ids,
      thesis_vertical_codex_guide_url: form.thesis_vertical_codex_guide_url,
      thesis_vertical_skill_pack_url: form.thesis_vertical_skill_pack_url,
      thesis_vertical_support_disciplines: form.thesis_vertical_support_disciplines,
      codex_client_skills_catalog_json: form.codex_client_skills_catalog_json,
